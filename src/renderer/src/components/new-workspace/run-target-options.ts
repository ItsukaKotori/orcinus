...
/** A row in the run-target list. Hosts commit; the recipes row opens a submenu. */
...
/**
 * Filters hosts and recipes by a typed query. The recipes submenu row survives
 * filtering only while it still has something to show.
 */
